...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class iTweenMoveTo_v2 : iTweenFsmAction
	{
		[RequiredField]
		...
		[Tooltip("How much of a percentage (from 0 to 1) to look ahead on a path to influence how strict Orient To Path is and how much the object will anticipate each curve. 0.001 is good for following path")]
