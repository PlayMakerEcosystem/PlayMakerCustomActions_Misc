...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class ArrayListSetNextEmpty : ArrayListActions
    {
        ...
        [Tooltip(
            "Author defined Reference of the PlayMaker ArrayList Proxy component (necessary if several component coexists on the same GameObject)")]
        ...
        [ActionSection("Store Index")] [UIHint(UIHint.FsmInt)] [Tooltip("The index it was added at")]
        ...
        [UIHint(UIHint.FsmEvent)] [Tooltip("No empty space in array list.")] [TitleAttribute("None Empty")]
